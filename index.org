...
* Table of Contents                                 :TOC:
 ...
 - [[#statistical-data-for-decision-support][Statistical Data for Decision Support]]
   ...
   - [[#comtrade-statistics][ComTrade Statistics]]
     ...
     - [[#comtrade-indicators-and-commodities][ComTrade Indicators and Commodities]]
...
** ComTrade Statistics
We extracted ComTrade data as CSV from http://comtrade.un.org/data/, modeled it similar to EuroStat data and converted it like this.
The observations below describe Import/Export volume between Austri and Belgium for 2012 and commodity code 2 "Meat and edible meat offal", in Kilograms and USD.
...
We also calculate Total Trade Volume and Balance of Trade using simple SPARQL Update queries like this:
#+BEGIN_SRC sparql
insert {
...
*** ComTrade Indicators and Commodities
The 4 trade indicators are described as skos:Concepts:
#+BEGIN_SRC Turtle
...
Finally, we obtain commodity codes from the ComTrade data API and convert them to skos:Concepts using the following pattern:
#+BEGIN_SRC Turtle
